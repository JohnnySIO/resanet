...
def getFerie(date) :
	...
	paque = datetime.date(year,month,day) + datetime.timedelta(1)
	ascension = datetime.date(year,month,day) + datetime.timedelta(39)
	pentecote = datetime.date(year,month,day) + datetime.timedelta(50)
	
	an = datetime.date(year,1,1)
	travail = datetime.date(year,5,1)
	huitmai = datetime.date(year,5,8)
	nationale = datetime.date(year,7,14)
	assomption = datetime.date(year,8,15)
	toussaint = datetime.date(year,11,1)
	armistice = datetime.date(year,12,25)
	
	liste.append(str(paque))
	liste.append(str(ascension))
	liste.append(str(pentecote))
	liste.append(str(an))
	liste.append(str(travail))
	liste.append(str(huitmai))
	liste.append(str(nationale))
